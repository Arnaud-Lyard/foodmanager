...
const TokenSqlRepositoryMock =
  TokenSqlRepository as jest.Mock<TokenSqlRepository>;
...
const userMockFactory = (): User => {
  return {
    id: '5eb9f526-699c-4fa8-beaa-818b562e2ed6',
    firstName: 'first1',
    lastName: 'last1',
...
const jwtTokenMockFactory = () => {
  const jwtTokenMock =
    new JwtTokenAdapterMock() as jest.Mocked<JwtTokenAdapter>;
...
describe('SignIn', () => {
  ...
  it('should call jwtTokenMock with correct values', async () => {
    ...
    expect(tokenSqlRepository.create).toHaveBeenCalledWith({
      token: 'any',
      expiresIn: new Date('2020-01-01T00:00:00-0300'),
      userId: '5eb9f526-699c-4fa8-beaa-818b562e2ed6',
    });
  });
